...
export function CommandPalette({ open, onClose, onToggleSidebar }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      { id: 'timesheet', label: 'Go to Timesheet', icon: ClockIcon, href: '/timesheet', section: 'Navigation' },
                          ...
                          .map((item) => {
                            ...
                            return (
                              <button
                                ...
                                className={cn(
                                  'flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-[13px] font-medium transition-all active:scale-[0.98]',
                                  isActive
