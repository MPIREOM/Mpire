          ...
          <div className="mt-6 flex items-start gap-5">
            ...
            <div className="min-w-0 flex-1 space-y-4">
              ...
              <div>
                ...
                {user.phone_number ? (
                  <span className="inline-flex items-center gap-1.5 rounded-lg bg-green/10 px-3 py-1.5 text-[13px] font-semibold text-green">
                    <PhoneIcon className="h-3.5 w-3.5" />
                    Active — {user.phone_number}
                  </span>
                ) : (
                  <span className="inline-flex items-center rounded-lg bg-bg px-3 py-1.5 text-[13px] font-semibold text-muted">
                    Not set up — ask your owner to add your phone number
                  </span>
                )}
              </div>
